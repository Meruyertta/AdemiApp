...
public class DrawerRecycleViewAdapter extends RecyclerView.Adapter<DrawerRecycleViewAdapter.ViewHolder>{
    ...
    public DrawerRecycleViewAdapter(List<DrawerItem> items){
        this.items = items;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        holder.drawerRecycleViewAdapter=this;
        return holder;
    }
...
//        }
    ...
    static abstract class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        private DrawerRecycleViewAdapter drawerRecycleViewAdapter;
        ...
        public void onClick(View v){
            drawerRecycleViewAdapter.setSelected(getAdapterPosition());
        }
    }
